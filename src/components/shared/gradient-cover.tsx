...
const gradientMap: Record<string, string> = {
  "gradient-teal": "from-[#00E5FF]/30 via-[#2F7BFF]/20 to-slate-900",
...
export function AuroraBackground({ className }: { className?: string }) {
  return (
    <div className={cn("pointer-events-none absolute inset-0 overflow-hidden", className)}>
      ...
      <div className="absolute bottom-[-15%] right-[10%] w-[35rem] h-[35rem] rounded-full bg-[#7B61FF]/20 blur-[120px] animate-pulse-slow" style={{ animationDelay: "1s" }} />
