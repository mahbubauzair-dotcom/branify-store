...
const gradientMap: Record<string, string> = {
  "gradient-teal": "from-teal-500/30 via-teal-700/20 to-slate-900",
...
export function AuroraBackground({ className }: { className?: string }) {
  return (
    <div className={cn("pointer-events-none absolute inset-0 overflow-hidden", className)}>
      <div className="absolute top-[-10%] left-[20%] w-[40rem] h-[40rem] rounded-full bg-teal-500/15 blur-[120px] animate-pulse-slow" />
      <div className="absolute bottom-[-15%] right-[10%] w-[35rem] h-[35rem] rounded-full bg-cyan-500/10 blur-[120px] animate-pulse-slow" style={{ animationDelay: "1s" }} />
